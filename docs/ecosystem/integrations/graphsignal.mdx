...
本页面介绍如何使用[Graphsignal](https://app.graphsignal.com)来跟踪和监控LangChain。Graphsignal可以全面查看您的应用程序。它提供了链路和工具的延迟分解、带有完整上下文的异常、数据监控、计算/GPU利用率、OpenAI成本分析等功能。
...
Graphsignal会自动对链路进行仪器化和启动跟踪和监控。然后可以在[Graphsignal仪表板](https://app.graphsignal.com)中查看跟踪和指标。
