...
本页介绍如何在LangChain中使用[llama.cpp](https://github.com/ggerganov/llama.cpp)。
分为两个部分：安装和设置，以及对特定的Llama-cpp包装器的引用。
...
存在一个LlamaCpp LLM包装器，可以通过以下方式访问
```python
