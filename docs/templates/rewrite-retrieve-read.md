...
这个模板实现了一种查询转换（重写）的方法，用于优化RAG，详见论文[Query Rewriting for Retrieval-Augmented Large Language Models](https://arxiv.org/pdf/2305.14283.pdf)。
...
我们可以在[http://127.0.0.1:8000/rewrite_retrieve_read/playground](http://127.0.0.1:8000/rewrite_retrieve_read/playground)上访问playground。
