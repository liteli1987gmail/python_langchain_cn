# 🦜🔗 LangChain 工具和项目的精选清单 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) ![GitHub Repo stars](https://img.shields.io/github/stars/kyrolabs/awesome-langchain?style=social)
![LangChain](https://pica.zhimg.com/50/v2-56e8bbb52aa271012541c1fe1ceb11a2_r.gif 'LangChain中文网')


LangChain 是一个优秀的框架，可帮助您在短时间内完成LLM项目，而且生态系统正在快速发展。以下是记录 LangChain 周边动态的尝试。

## 我们还有一个每周的新闻通讯来分享 LangChain 生态系统的最新动态（变更日志、文章、视频、项目） **[在此订阅通讯](https://awesomelangchain.substack.com/)**

欢迎贡献新链接。您可以通过提交 pull requests 添加链接或创建一个问题来开始讨论。在贡献前请务必阅读[贡献指南](CONTRIBUTING.md)。
