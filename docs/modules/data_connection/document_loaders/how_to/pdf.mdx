...
>[便携式文档格式（PDF）](https://zh.wikipedia.org/wiki/PDF)，标准化为ISO 32000，是Adobe于1992年开发的一种文件格式，用于以与应用软件、硬件和操作系统无关的方式呈现文档，包括文本格式和图像。

这涵盖了如何将`PDF`文档加载到我们在下游使用的Document格式中。
