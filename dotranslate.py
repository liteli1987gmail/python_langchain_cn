...
examples_json = """
"{"relative_path": "<!--版权信息$n$n-->$n$n# 管道的实用工具$n$n本页列出了库提供的所有用于管道的实用函数。$n$n如果您正在研究库中的模型代码，那么这些函数大多数情况下是有用的。$n$n$n## 参数处理$n$n[[autodoc]] pipelines.ArgumentHandler$n$n","relative_path_other.md":"import CodeBlock from "@theme/CodeBlock";$n$n### 应用场景$n$n"}"
"""
